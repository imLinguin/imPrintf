        ...
        switch (args[0]) {
            case "map":
                ...
                const embed = new MessageEmbed()
                    ...
                    .setImage(lastMap.urlPOI || "https://miro.medium.com/max/978/1*pUEZd8z__1p-7ICIO1NZFA.png")
            ...
            case "stats":
                ...
                const recentGames = await fortniteAPI.getPlayerRecentMatches(ID.account_id)

                if (stats.result === true && stats.global_stats !== null) {
                    const embed = new MessageEmbed()
                        .setTitle(`${stats.name}'s level: **${stats.account.level ? stats.account.level : "NO DATA"}**`)
                        .addFields({
                            name: `SOLO`,
            ...
            case "server":
                ...
                message.reply(`${isOnline ? "Fortnite is online 🟢" : "Fortnite is down 🔴"}`)
                break;
